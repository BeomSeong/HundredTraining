...
<%@ page import="com.study.springboot.dto.PaymentDto" %>
<%@ page import="com.study.springboot.service.ShopService" %>
...
<%
 ...
 // @docs https://docs.tosspayments.com/guides/payment-widget/integration#3-결제-승인하기
  ...
  String secretKey = "test_sk_ex6BJGQOVDOz9vaaEPZX3W4w2zNb:";
